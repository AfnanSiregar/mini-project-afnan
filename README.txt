...
-   Di tab Import klik choose file, cari db_project_muzayyin.sql dari folder mini-project-assignment, kemudian impor
-   Selanjutnya, buka folder mini-project-assignment dengan Visual Studio Code atau Sublime Text,
-   Buka terminal, ketikkan command "composer update" (tanpa tanda kutip),
-   Buat file dengan nama ".env" (tanpa tanda kutip) di folder paling luar mini-project-assignment,
